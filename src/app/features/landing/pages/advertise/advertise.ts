...
export class Advertise implements OnInit {
  ...
  private setMeta(): void {
    ...
    this.meta.updateTag({ name: 'description', content: 'Partner with ApnaInsights - India\'s practical knowledge platform. Advertise via sponsored shorts, blog features, and newsletter placements. Reach engaged readers across 16 categories including Technology, Health, Sports and more.' });
