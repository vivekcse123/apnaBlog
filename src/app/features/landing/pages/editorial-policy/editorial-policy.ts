...
export class EditorialPolicy implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    ...
    this.meta.updateTag({ name: 'description', content: 'ApnaInsights Editorial Policy — learn how we review, moderate, and maintain quality standards for all content published on our community blogging platform.' });
